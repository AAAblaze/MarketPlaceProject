...
////use only one time, to be called to set the databse
...
//    let pet = Category(_name : "Pets products", _imageName: "pet")
//    let industry = Category(_name : "Instury & Business", _imageName: "industry")
//    let garden = Category(_name : "Garden supplies", _imageName: "garden")
//    let camera = Category(_name : "Cameras & Optics", _imageName: "camera")
//    let arrayOfCategories = [womenClothing, footWear, electronics, menClothing, health, baby,home,
//    car, luggage, jewelery, hobby, pet, industry, garden, camera]
//
